document.addEventListener("DOMContentLoaded", function () {
    ...
    function checkFlag() {
        ...
        const correctFlag = "base64_decode_challenge"; // Decoded from the Base64 message

        if (userInput === correctFlag) {
            resultElement.textContent = "✅ Correct! You decoded the message!";
            resultElement.style.color = "#00E6E6";

            // Update the score on the server
            updateScore(60); // Total score for completing this challenge
        } else {
            resultElement.textContent = "❌ Incorrect! Try decoding again.";
